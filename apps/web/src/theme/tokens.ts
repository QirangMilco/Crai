...
export const TOKENS: TokenDef[] = [
  ...
  { name: '--crai-msg-user-font-size', label: '字号', group: 'user-msg', type: 'size', defaultValue: '14px', max: 32 },
  { name: '--crai-msg-user-line-height', label: '行高', group: 'user-msg', type: 'number', defaultValue: '1.6' },
  ...
  { name: '--crai-msg-ai-font-size', label: '字号', group: 'ai-msg', type: 'size', defaultValue: '14px', max: 32 },
  { name: '--crai-msg-ai-line-height', label: '行高', group: 'ai-msg', type: 'number', defaultValue: '1.6' },
  ...
  { name: '--crai-msg-gap', label: '消息间距', group: 'ai-msg', type: 'size', defaultValue: '8px', max: 40 },
  ...
  { name: '--crai-md-code-radius', label: '圆角', group: 'code-block', type: 'size', defaultValue: '8px' },
  ...
  { name: '--crai-input-font-size', label: '文本区字号', group: 'input-field', type: 'size', defaultValue: '14px', max: 32, description: '输入框文本区的字体大小' },
  { name: '--crai-input-line-height', label: '文本区行高', group: 'input-field', type: 'number', defaultValue: '1.6' },
...
export const THEME_PRESETS: ThemePreset[] = [
  { name: 'Crai 默认（浅色）', tokens: { ...buildPreset({}).tokens } },
  {
    ...
    tokens: buildPreset({
      ...
      '--crai-md-code-fg': '#f1f5f9', '--crai-md-table-fg': '#f1f5f9', '--crai-md-table-body-bg': '#1e293b',
